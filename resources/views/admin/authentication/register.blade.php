    ...
    <div class="col-lg-4 col-sm-12">
        <form class="card auth_form">
            ...
            <div class="body">
                ...
                <a href="{{ route('admin.dashboard.index') }}" class="btn btn-primary btn-block waves-effect waves-light">SIGN UP</a>
                <div class="signin_with mt-3">
                    <a class="link" href="{{ route('admin.authentication.login') }}">You already have a membership?</a>
                </div>
            </div>
        </form>
