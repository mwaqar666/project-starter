...
<div class="row">
    <div class="col-lg-4 col-sm-12">
        <form class="card auth_form">
            ...
            <div class="body">
                ...
                <a href="{{ route('admin.dashboard.index') }}" class="btn btn-primary btn-block waves-effect waves-light">GO TO HOMEPAGE</a>
    ...
    <div class="col-lg-8 col-sm-12">
        <div class="card">
            <img src="{{ asset('assets/admin/images/signin.svg') }}" alt="500"/>
        </div>
    </div>
</div>
@stop
