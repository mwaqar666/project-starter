        ...
        <div class="d-flex">
            ...
            <div class="inbox right">
                <div class="card">
                    ...
                    <div class="body">
                        <a href="{{ route('admin.app.compose') }}" class="p-2"><i class="zmdi zmdi-mail-reply"></i> Reply</a> or
                        <a href="{{ route('admin.app.compose') }}" class="p-2"><i class="zmdi zmdi-mail-send"></i> Forward</a>
                    </div>
                </div>
            </div>
        </div>
