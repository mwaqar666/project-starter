        ...
        <div class="card">
            <div class="blogitem mb-5">
                <div class="blogitem-image">
                    <a href="javascript:void(0);"><img src="{{ asset('assets/admin/images/image-gallery/5.jpg') }}" alt="blog image"></a>
        ...
        <div class="card">
            ...
            <div class="">
                <ul class="comment-reply list-unstyled">
                    <li>
                        <div class="icon-box"><img class="img-fluid img-thumbnail" src="{{ asset('assets/admin/images/sm/avatar2.jpg') }}" alt="Awesome Image"></div>
                        <div class="text-box">
                            <h5>Kareem Todd</h5>
                    ...
                    <li>
                        <div class="icon-box"><img class="img-fluid img-thumbnail" src="{{ asset('assets/admin/images/sm/avatar1.jpg') }}" alt="Awesome Image"></div>
                        <div class="text-box">
