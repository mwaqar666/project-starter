...
@stop
@section('page-script')
<script src="{{ asset('assets/admin/plugins/editable-table/mindmup-editabletable.js') }}"></script>
<script src="{{ asset('assets/admin/js/pages/tables/editable-table.js') }}"></script>
@stop
