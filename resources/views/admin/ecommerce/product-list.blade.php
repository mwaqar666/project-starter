...
@section('page-style')
<link rel="stylesheet" href="{{ asset('assets/admin/plugins/footable-bootstrap/css/footable.bootstrap.min.css') }}">
<link rel="stylesheet" href="{{ asset('assets/admin/plugins/footable-bootstrap/css/footable.standalone.min.css') }}">
@stop
@section('content')
        ...
        <div class="card">
            <div class="table-responsive">
                <table class="table table-hover product_item_list c_table theme-color mb-0">
                    ...
                    <tbody>
                        <tr>
                            <td><img src="{{ asset('assets/admin/images/ecommerce/1.png') }}" width="48" alt="Product img"></td>
                        ...
                        <tr>
                            <td><img src="{{ asset('assets/admin/images/ecommerce/10.png') }}" width="48" alt="Product img"></td>
                        ...
                        <tr>
                            <td><img src="{{ asset('assets/admin/images/ecommerce/11.png') }}" width="48" alt="Product img"></td>
                        ...
                        <tr>
                            <td><img src="{{ asset('assets/admin/images/ecommerce/5.png') }}" width="48" alt="Product img"></td>
                        ...
                        <tr>
                            <td><img src="{{ asset('assets/admin/images/ecommerce/6.png') }}" width="48" alt="Product img"></td>
                            <td><h5>Simple Black Clock</h5></td>
                        ...
                        <tr>
                            <td><img src="{{ asset('assets/admin/images/ecommerce/2.png') }}" width="48" alt="Product img"></td>
                        ...
                        <tr>
                            <td><img src="{{ asset('assets/admin/images/ecommerce/3.png') }}" width="48" alt="Product img"></td>
                            <td><h5>Simple Black Clock</h5></td>
...
@stop
@section('page-script')
<script src="{{ asset('assets/admin/bundles/footable.bundle.js') }}"></script>
<script src="{{ asset('assets/admin/js/pages/tables/footable.js') }}"></script>
@stop
