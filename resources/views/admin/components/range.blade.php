...
@section('page-style')
<link rel="stylesheet" href="{{ asset('assets/admin/plugins/ion-rangeslider/css/ion.rangeSlider.css') }}"/>
@stop
@section('content')
...
@stop
@section('page-script')
<script src="{{ asset('assets/admin/plugins/ion-rangeslider/js/ion.rangeSlider.js') }}"></script>
<script src="{{ asset('assets/admin/js/pages/ui/range-sliders.js') }}"></script>
@stop
