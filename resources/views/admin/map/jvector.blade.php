...
<script src="{{ asset('assets/admin/plugins/jvectormap/jquery-jvectormap-in-mill.js') }}"></script>
...
<script src="{{ asset('assets/admin/plugins/jvectormap/jquery-jvectormap-au-mill.js') }}"></script>
<script src="{{ asset('assets/admin/js/pages/maps/jvectormap.js') }}"></script>
@stop
