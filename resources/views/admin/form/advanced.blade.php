...
<link rel="stylesheet" href="{{ asset('assets/admin/plugins/multi-select/css/multi-select.css') }}"/>
<link rel="stylesheet" href="{{ asset('assets/admin/plugins/jquery-spinner/css/bootstrap-spinner.css') }}"/>
...
<link rel="stylesheet" href="{{ asset('assets/admin/plugins/nouislider/nouislider.min.css') }}"/>
...
<script src="{{ asset('assets/admin/plugins/jquery-spinner/js/jquery.spinner.js') }}"></script>
